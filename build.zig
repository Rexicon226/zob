...
pub fn build(b: *std.Build) !void {
    ...
    if (use_z3) {
        ...
        compiler.root_module.addImport("z3", z3.module("z3"));
    }
    ...
    if (use_z3) {
        const z3 = b.lazyDependency("z3", .{ .target = target, .optimize = optimize }) orelse return;
        zob_mod.addImport("z3", z3.module("z3"));
    }
    ...
    if (use_z3) {
        const z3 = b.lazyDependency("z3", .{ .target = target, .optimize = optimize }) orelse return;
        test_lib.root_module.addImport("z3", z3.module("z3"));
    }
    ...
    if (use_z3) {
        const z3 = b.lazyDependency("z3", .{ .target = target, .optimize = optimize }) orelse return;
        test_runner.root_module.addImport("z3", z3.module("z3"));
    }
